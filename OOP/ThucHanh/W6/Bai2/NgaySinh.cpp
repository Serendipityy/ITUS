...
void NgaySinh::ghi(ofstream& file) {
    file.write(reinterpret_cast<char*>(this), sizeof(NgaySinh));
}

void NgaySinh::doc(ifstream& file) {
    file.read(reinterpret_cast<char*>(this), sizeof(NgaySinh));
}

NgaySinh& NgaySinh::operator=(const NgaySinh& other) {
    if (this != &other) {
