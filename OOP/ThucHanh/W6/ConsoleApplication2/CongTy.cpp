...
void CongTy::docDSNhanVienTuFile(const char* fileName) {
	...
	// Cấp phát lại bộ nhớ cho mảng dsnv
	dsnv = new NhanVien * [soNV];
...
//////////////////////////
//void CongTy::load(ifstream& in) {
//	for (int i = 0; i < soNV; i++) {
//		int loaiNV;
//		in.read((char*)&loaiNV, sizeof(int));
//		if (loaiNV == 1) {
//			dsnv[i] = new NVSanXuat();
//		}
//		else if (loaiNV == 2) {
...
//}
//
//void CongTy::store(ofstream& out) {
//	for (int i = 0; i < soNV; i++) {
//		if (dynamic_cast<NVSanXuat*>(dsnv[i])) {
//			int loaiNV = 1;
//			out.write((char*)&loaiNV, sizeof(int));
//		}
//		else if (dynamic_cast<NVCongNhat*>(dsnv[i])) {
//			int loaiNV = 2; 
//			out.write((char*)&loaiNV, sizeof(int));
//		}
//		dsnv[i]->store(out);
...
//void CongTy::add(NhanVien* nv, int type) {
//	// Tạo một mảng tạm thời có kích thước lớn hơn danh sách hiện tại
//	NhanVien** temp = new NhanVien * [soNV + 1];
//
//	// Sao chép thông tin nhân viên từ danh sách hiện tại sang mảng tạm thời
//	for (int i = 0; i < soNV; i++) {
//		temp[i] = dsnv[i];
//	}
//
//	// Thêm nhân viên mới vào cuối danh sách
//	temp[soNV] = nv;
//
//	// Giải phóng danh sách nhân viên hiện tại
//	delete[] dsnv;
//
//	// Cập nhật danh sách nhân viên thành danh sách mới
//	dsnv = temp;
//
...
//
//void CongTy::store(ofstream& out) {
//	// Ghi thông tin từng nhân viên vào file
//	for (int i = 0; i < soNV; i++) {
//		if (dynamic_cast<NVSanXuat*>(dsnv[i])) {
//			int loaiNV = 1;
//			out.write((char*)&loaiNV, sizeof(int));
...
//		NhanVien* nv = nullptr;
//		if (type == 1) nv = new NVSanXuat;
//		else nv = new NVCongNhat;
//		nv->load(in);
//		if (strlen(nv->getMaNV()) == 0) delete nv;
//		else add(nv, type);
//	}
//}
