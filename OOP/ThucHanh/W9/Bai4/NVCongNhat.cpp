...
/////////////////////////////////
/////////////////////////////////////
//void NVCongNhat::load(ifstream& in) {
//    NVCongNhat cn;
//    in.read((char*)&cn, sizeof(cn));
//    *this = cn;
//}
//
//void NVCongNhat::store(ofstream& out) {
//    out.write((char*)this, sizeof(NVCongNhat));
//}
//
//NVCongNhat& NVCongNhat::operator=(const NVCongNhat& cn) {
//    if (this != &cn) {
//        this->NhanVien::operator=(cn);
//        this->soNgayLam = cn.soNgayLam;
//    }
//    return *this;
//}